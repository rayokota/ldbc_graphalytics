 ...
 */
package science.atlarge.graphalytics.kgraphs.algorithms.sssp;
...
/**
 * Single Source Shortest Paths job implementation for KafkaGraphs. This class is responsible for formatting SSSP-specific
 * arguments to be passed to the platform executable, and does not include the implementation of the algorithm.
 *
 * @author Robert Yokota
 */
public final class SingleSourceShortestPathsJob extends KafkaGraphsJob {
	...
	public SingleSourceShortestPathsJob(RunSpecification runSpecification,
										KafkaGraphsConfiguration platformConfig,
