 ...
 */
public final class KafkaGraphsConfiguration {

	protected static final Logger LOG = LogManager.getLogger();

	private static final String BENCHMARK_PROPERTIES_FILE = "benchmark.properties";
	private static final String HOME_PATH_KEY = "platform.kgraphs.home";
	private static final String NUM_MACHINES_KEY = "platform.kgraphs.num-machines";
	private static final String NUM_THREADS_KEY = "platform.kgraphs.num-threads";
	...
	/**
	 * Creates a new KafkaGraphsConfiguration object to capture all platform parameters that are not specific to any algorithm.
	 */
	public KafkaGraphsConfiguration(){
	}
	...
	public static KafkaGraphsConfiguration parsePropertiesFile() {

		KafkaGraphsConfiguration platformConfig = new KafkaGraphsConfiguration();
