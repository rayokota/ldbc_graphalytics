 ...
 */
package science.atlarge.graphalytics.kgraphs.algorithms.pr;
...
/**
 * Page Rank job implementation for KafkaGraphs. This class is responsible for formatting PR-specific
 * arguments to be passed to the platform executable, and does not include the implementation of the algorithm.
 *
 * @author Robert Yokota
 */
public final class PageRankJob extends KafkaGraphsJob {
	 ...
	 */
	public PageRankJob(RunSpecification runSpecification, KafkaGraphsConfiguration platformConfig,
