 ...
 */
public class KafkaGraphsLoader {

	private static final Logger LOG = LogManager.getLogger();

	protected CommandLine commandLine;
	protected FormattedGraph formattedGraph;
	protected KafkaGraphsConfiguration platformConfig;


	/**
	 *	Graph loader for KafkaGraphs.
	 * @param formattedGraph
	 * @param platformConfig
	 */
	public KafkaGraphsLoader(FormattedGraph formattedGraph, KafkaGraphsConfiguration platformConfig) {
